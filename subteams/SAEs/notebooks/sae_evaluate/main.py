...
def parse_args():
    ...
    parser.add_argument("--batch_size", type=int, default=2, help="Batch size for processing solutions")
    parser.add_argument("--num_threads", type=int, default=2, help="Number of threads for parallel processing")
    
    parser.add_argument("--encoders", nargs="*", type=int, default=[1,2,3], help="List of encoder layers to keep")
    parser.add_argument("--decoders", nargs="*", type=int, default=[], help="List of decoder layers to keep")
    
    parser.add_argument("--cross_attention", action="store_false", help="Enable cross attention activations")
